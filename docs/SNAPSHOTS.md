...
- Restructured the dashboard layout:
  ...
  - Styled all panels (`.hero-panel`, `.side-panel`, `.metric-card`, `.priority-chart`) to use flex column layouts for visual alignment and equal-height stretching, and removed a leftover `grid-row: span 2` media query conflict.
